...
public class NiChengActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        String stringExtra = intent.getStringExtra("8");
        ...
        ok_ed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ed_nicehng.getText().toString().length()!=0){
                    Intent intent2 = intent1.putExtra("3", ed_nicehng.getText().toString());
                    setResult(98,intent2);
                    finish();
                }else {
                    Toast.makeText(NiChengActivity.this, "不能为空", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
